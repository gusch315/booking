    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.CharField(max_length=10, verbose_name='予約日')),
                ('name', models.CharField(max_length=255, verbose_name='予約者')),
                ('grade', models.CharField(max_length=1, verbose_name='回生')),
                ('band', models.CharField(max_length=255, verbose_name='予約バンド')),
